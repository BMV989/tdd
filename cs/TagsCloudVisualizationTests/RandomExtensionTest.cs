...
public class RandomExtensionTest
{
    ...
    public void RandomSize_ShouldThrowArgumentOutOfRangeException_WithInvalidParams(int minValue, int maxValue)
    {
        Action act = () => random.RandomSize(minValue, maxValue);
